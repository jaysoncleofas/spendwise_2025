<template>
    <div class="px-4 sm:px-0">
      ...
      <div v-if="currencySummary && hasMultipleCurrencies" class="card mb-6 bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900/30 dark:to-primary-800/30">
